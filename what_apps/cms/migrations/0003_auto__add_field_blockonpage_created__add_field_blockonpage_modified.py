...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlockOnPage.modified'
        db.add_column('cms_blockonpage', 'modified',
                      self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BlockOnPage.created'
        db.delete_column('cms_blockonpage', 'created')

        # Deleting field 'BlockOnPage.modified'
        db.delete_column('cms_blockonpage', 'modified')
