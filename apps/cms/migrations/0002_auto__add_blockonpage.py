...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlockOnPage'
        db.create_table('cms_blockonpage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'])),
            ('block', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.ContentBlock'])),
        ))
        db.send_create_signal('cms', ['BlockOnPage'])

    def backwards(self, orm):
        # Deleting model 'BlockOnPage'
        db.delete_table('cms_blockonpage')
    ...
    models = {
        ...
        'cms.blockonpage': {
            'Meta': {'object_name': 'BlockOnPage'},
            'block': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.ContentBlock']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
